...
class AlarmViewModel: ObservableObject {
    ...
    func addAlarm(name: String, time: Date, music: String, alarmDuration: String, repeats: [(String, Bool)]) {
        ...
        NotificationController.shared.scheduleRepeatedNotification(id: id, title: name, for: repeats, on: time, stopDuration: alarmDuration, musicName: music)
    ...
    func editAlarm(alarm: Alarm, name: String, time: Date, music: String, activityDuration: String, repeats: [(String, Bool)]) {
        ...
        NotificationController.shared.scheduleRepeatedNotification(id: alarm.id!, title: name, for: repeats, on: time, stopDuration: activityDuration, musicName: music)
